var commentsData = [
	...
	{id:5, user_id:5, date:"2018-06-14 22:01", text:"There are things that you cannot solve by jumping in an X-wing and blowing something up, Daizy)))<br>Okay, guys, let's meet in person, discuss the finale details of the plan and let's begin at last."},
	{id:6, user_id:4, date:"2018-06-14 22:31", text:"One more question, guys. What about the latest specifications?"},
	{id:7, user_id:3, date:"2018-06-14 22:43", text:"They are ready, but not published yet."},
	{id:8, user_id:4, date:"2018-06-14 23:01", text:"Wow great, could you please share them with me?"},
	{id:9, user_id:3, date:"2018-06-14 23:15", text:"No worry, I am planning to finish it up in half an hour and make them public for all. Just wait..)"}
];

var usersData = [
	{ id:1, value:"Corvo Attano", image: "./common/imgs/corvo.jpg" },
	{ id:2, value:"Daisy Fitzroy", image: "./common/imgs/daisy.jpg" },
	{ id:3, value:"Glenn Crake", image: "./common/imgs/glenn.jpg"  },
	{ id:4, value:"Me", image: "./common/imgs/tomek.jpg"  },
	{ id:5, value:"Leia Organa", image: "./common/imgs/leia.jpg"  }
];
